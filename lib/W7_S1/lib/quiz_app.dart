...
import '../lib/screens/welcome/main.dart';
import '../lib/screens/question/main.dart';
import '../lib/screens/result/main.dart';
...
class _QuizAppState extends State<QuizApp> {
  ...
  Widget build(BuildContext context) {
    switch (quizState) {
      ...
      case Pages.started:
        return QuestionScreen(question: widget.quiz.questions[currentIndex], submitAnswer: submitAnswer);
      case Pages.finished:
        return ResultScreen(onRestart: onRestart, submit: submit, quiz: widget.quiz,);
      default:
        return WelcomeScreen(title: widget.quiz.title, onStart: switchPage);
    }
  }
