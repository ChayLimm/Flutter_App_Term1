...
import 'package:fluttermain/W7_S1/lib/screens/result/restartButton.dart';
...
class ResultScreen extends StatelessWidget {
  ...
  const ResultScreen({super.key, required this.submit,required this.onRestart, required this.quiz});
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                margin: const EdgeInsets.symmetric(horizontal:10,vertical: 44),
                child: Text("$score / $fullscore Score",style: const TextStyle(
                      color: Colors.black,
                      fontFamily: 'Roboto',
                      fontSize: 32,
